...
sudo ethtool -K $tibit_int rxhash off
sudo ethtool -N $tibit_int flow-type ip4 action 1
sudo ethtool -N $tibit_int flow-type udp4 action 1
sudo ethtool -N $tibit_int flow-type tcp4 action 1
